...
2. Import file `database.sql` (nếu có trong thư mục) vào database vừa tạo.
3. Cấu hình lại thông tin kết nối (Username, Password) trong file `server/config/db.js` hoặc file `.env` của thư mục Backend.
...
📝 Tác giả (Author)
[Tên của bạn] - Software Engineering Student at VNUA
